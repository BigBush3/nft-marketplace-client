...
const defaultFaqItem: Types.AboutArticles = {
  ...
  },
  {
    ...
    description: `<p>Печать верификации - это специальный символ для верифицированных NFT, или для NFT, которые прошли патентованную систему токенизации iNifty. Этот символ означает, что NFT был лично проверен и исследован арт экспертом и оценщиком.</p><p>Печать верификации предоставляется NFT, которые были токенизированы при помощи новой патентированной системы iNifty глобального стандарта токенизации и верификации, при участии аккредитированных арт экспертов. Таким образом, артисты, коллекционеры, дилеры могут создавать и токенизировать предметы искусства, зарегистрированных на системе блокчейн.</p>
                  `,
  },{
